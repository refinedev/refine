        ...
        <Group title="Settings">
          ...
          >
            <Form.Item label="Mutation mode" style={formItemStyles}>
              ...
              >
                <Select.Option value="pessimistic">Pessimistic</Select.Option>
                <Select.Option value="optimistic">Optimistic</Select.Option>
                <Select.Option value="undoable">Undoable</Select.Option>
              </Select>
            </Form.Item>
            {mutationMode === "undoable" && (
              <Form.Item label="Timeout to revert" style={formItemStyles}>
                <InputNumber<number>
                  size="small"
                  min={0}
                  step={1000}
                  value={undoableTimeout}
                  onChange={(value) => onUndoableTimeoutChange(value ?? 0)}
                />
              </Form.Item>
            )}
            <Form.Item label="Sync with location" style={formItemStyles}>
              <Switch
                size="small"
            ...
            <Form.Item label="Warn if unsaved changes" style={formItemStyles}>
              <Switch
                size="small"
