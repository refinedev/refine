...
Run the following command to create a new **refine** project configured with  [Mantine](https://mantine.dev/) as the default UI framework:

```
npm create refine-app -- --preset refine-mantine
```
...
<a href="http://localhost:3000">![Welcome on board](https://github.com/refinedev/refine/blob/master/documentation/static/img/mantine_welcome.png?raw=true)</a>
...
![First example result](https://github.com/refinedev/refine/blob/master/documentation/static/img/mantine_first_page.png?raw=true)
...
👉 Jump to [Refine<>Mantine Tutorial](https://refine.dev/docs/tutorials/mantine-tutorial) to continue your work and turn the example into a full-blown CRUD application.
