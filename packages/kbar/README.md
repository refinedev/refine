...
For more detailed information and usage, refer to the [refine kbar command palette documentation](https://refine.dev/docs/packages/command-palette).

## Install

```
npm install @pankod/refine-kbar
```
