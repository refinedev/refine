...
import { ChakraUIInferencer } from "../index";
    ...
    const renderingList = render(
      <Wrapper>
        <Routes>
          <Route
            path="/custom-page"
            element={<ChakraUIInferencer resource="posts" action="list" />}
          />
        </Routes>
      </Wrapper>,
    );
    ...
    const renderingCreate = render(
      <Wrapper>
        <Routes>
          <Route
            path="/custom-page"
            element={<ChakraUIInferencer resource="posts" action="create" />}
          />
        </Routes>
      </Wrapper>,
    );
      ...
      <Wrapper>
        <Routes>
          <Route
            path="/custom-page"
            element={
              <ChakraUIInferencer resource="posts" action="edit" id="11" />
            }
          />
        </Routes>
      </Wrapper>,
      ...
      <Wrapper>
        <Routes>
          <Route
            path="/custom-page"
            element={
              <ChakraUIInferencer resource="posts" action="show" id="21" />
            }
          />
        </Routes>
      </Wrapper>,
