    ...
    const renderingList = render(
      <Wrapper>
        <Routes>
          <Route
            path="/custom-page"
            element={<AntdInferencer resource="posts" action="list" />}
          />
        </Routes>
      </Wrapper>,
    );
    ...
    const renderingCreate = render(
      <Wrapper>
        <Routes>
          <Route
            path="/custom-page"
            element={<AntdInferencer resource="posts" action="create" />}
          />
        </Routes>
      </Wrapper>,
    );
    ...
    const renderingEdit = render(
      <Wrapper>
        <Routes>
          <Route
            path="/custom-page"
            element={<AntdInferencer resource="posts" action="edit" id="11" />}
          />
        </Routes>
      </Wrapper>,
    );
    ...
    const renderingShow = render(
      <Wrapper>
        <Routes>
          <Route
            path="/custom-page"
            element={<AntdInferencer resource="posts" action="show" id="21" />}
          />
        </Routes>
      </Wrapper>,
    );
