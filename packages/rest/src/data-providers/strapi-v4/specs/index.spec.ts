...
describe("dataProvider", () => {
  ...
  beforeAll(() => {
    localStorage.setItem(
      ACCESS_TOKEN_KEY,
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNjU1Mjc0MTIzLCJleHAiOjE2NTc4NjYxMjN9.Au8NsqnS2mjtKBHf1oRl-juEQ_l9JZrPk4Fsv4GsvVA",
    );
  });
  ...
  describe("getList", () => {
    it("correct response", async () => {
      const { data, total } = await dataProvider.getList({ resource: "posts" });
