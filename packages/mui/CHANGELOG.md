...
*   [#1888](https://github.com/pankod/refine/pull/1888) [`2b9f2f837a`](https://github.com/pankod/refine/commit/2b9f2f837aab8d7796f32cccea7ae2d46bfd08bc) Thanks [@aliemir](https://github.com/aliemir)! - - Update in `useDataGrid` hook: set `defaultSetFilterBehavior` property in `useTable` to `replace` (defaults to `merge` in `@pankod/refine-core`)
...
-   [#1889](https://github.com/pankod/refine/pull/1889) [`683fd6f932`](https://github.com/pankod/refine/commit/683fd6f932624e284195005c8408935a89da73d3) Thanks [@biskuvit](https://github.com/biskuvit)! - I fixed mui ready-page to be responsive for mobile screens.
...
*   [#1890](https://github.com/pankod/refine/pull/1890) [`607de3446b`](https://github.com/pankod/refine/commit/607de3446ba314a05e9deca88dd41a09f343e7b9) Thanks [@biskuvit](https://github.com/biskuvit)! - fixed the `<ErrorComponent/>` to be responsive to mobile screens
