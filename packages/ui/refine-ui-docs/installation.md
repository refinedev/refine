...
```bash
npx shadcn@latest add http://localhost:3000/r/error-component.json
```
...
```bash
npx shadcn@latest add http://localhost:3000/r/loading-overlay.json
```
...
```bash
npx shadcn@latest add http://localhost:3000/r/theme-provider.json
```
