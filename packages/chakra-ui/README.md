...
👉 Jump to [Refine<>Chakra UI Tutorial](https://refine.dev/docs/tutorials/chakra-ui-tutorial/) to continue your work and turn the example into a full-blown CRUD application.
