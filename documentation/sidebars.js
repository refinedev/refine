            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        "routing/examples/next-js/nextjs",
                        "routing/examples/next-js/nextjs-appdir",
                        "routing/examples/next-js/auth",
                        "routing/examples/next-js/NextAuth-js",
                        { type: "html", value: "Remix" },
                        "routing/examples/remix/remix-headless",
                        "routing/examples/remix/remix-auth",
                    ],
                },
            ],
        },
