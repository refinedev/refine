...
export const SectionFreeStart: React.FC = () => {
    ...
    return (
        ...
        <motion.div ref={ref} className="h-[500px] lg:h-[380px] bg-white">
            {/* Scroll animated section */}
            <motion.div className="h-[500px] lg:h-[380px] w-screen max-w-screen overflow-x-hidden top-0 left-0 relative lg:sticky pt-8 lg:pt-16 px-4 md:px-10 lg:px-16 xl:px-24 flex flex-col">
