      ...
      <div className="flex items-center gap-16">
        ...
        <div className="font-montserrat max-w-md text-center md:text-left">
          ...
          <p className="mb-0 text-base leading-tight">
            <b>refine</b> is an <b>open-source React-based framework</b>
            for building <b>CRUD applications</b> without constraints. Please
            show us your <b>support</b> with a shining <b>GitHub star</b>.
          </p>
        </div>
      </div>
