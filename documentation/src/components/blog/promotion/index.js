...
const PromotionBanner = ({ image, title, description, isDark }) => {
  ...
  if (description === "refineNew") {
    renderDescription = (
      <div>
        ...
        within your browser that you can preview, tweak and download instantly.
        <br />
        <br />🚀 By visually combining options for your preferred ✨
        <b> React platform,</b> ✨ <b>UI framework</b>, ✨{" "}
        <b>backend connector</b>, and ✨ <b>auth provider</b>; you can create
        tailor-made architectures for your project in seconds. It feels like
        having access to thousands of project templates at your fingertips,
    ...
    renderDescription = description ?? (
      <div>
        ...
        applications. With refine, you can be confident that your codebase will
        always stay clean and boilerplate-free.
        <br />
        <br />
        Try{" "}
        <a
  ...
  return (
    ...
    <a href="https://s.refine.dev/hackathon2" target="_blank" rel="noreferrer">
