...
const PropResource: React.FC<Props> = ({ hook, method, hasDefault = true }) => {
    ...
    See the [creating a data provider](/docs/api-reference/core/providers/data-provider/#creating-a-data-provider) section for an example of how resources are handled.`;

    return (
        <>
            {hasDefault && (
                <ReactMarkdown>
                    &gt; Default: It reads the `resource` value from the current
                    URL.
                </ReactMarkdown>
            )}
