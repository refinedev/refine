...
category: "Tutorials"
tags: [backend]
image: https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2023/2023-08-07-fast-api/social-2.png
...
The **main** represents the module import, and the **fastapi** is an instance of the FastAPI. The command above starts the server, which can then be accessed via the browser at **http://127.0.0.1:8000**.
 ...
 <div >
   <img  src="https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2023/2023-08-07-fast-api/cli.png"  alt="introduction to fast api " />
</div>
...
Once the server is running on the browser, visit **[http://127.0.0.1:8000/docs](http://127.0.0.1:8000/docs)**
 ...
 <div >
   <img  src="https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2023/2023-08-07-fast-api/preivew-api.png"  alt="introduction to fast api " />
</div>
...
Open the directory using your code editor.
 ...
 <div className="centered-image" >
   <img   width="300px"  src="https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2023/2023-08-07-fast-api/folder-structure.png"  alt="introduction to fast api " />
</div>
...
Starlette offers several other types of responses, including the **FileResponse**, which can then be used on the route handler.
 ...
 <div className="centered-image" >
   <img    src="https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2023/2023-08-07-fast-api/swagger-last.png"  alt="introduction to fast api" />
</div>
