...
tags: [dashboards, react]
image: https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2024/2024-02-23-recharts/social.png
...
<img src="https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2024/2024-02-23-recharts/recharts.png" alt="Recharts chart" />
</div>
...
<div className="centered-image">
<img src="https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2024/2024-02-23-recharts/dashboard.png" alt="Recharts chart" />
</div>
...
In the code above, we are using the `useCustom` hook to make custom query requests to the backend. The `useCustom` hook uses TanStack Query's `useQuery` hook under the hook. We have been querying the daily revenue, daily orders, and new customers of a restaurant business for the last seven days. We will represent the data in different types of charts. The dashboard should now have a Line chart that looks like the image below.
 ...
 <div className="centered-image">
<img src="https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2024/2024-02-23-recharts/line-chart.png" alt="Recharts chart" />
</div>
...
Your dashboard should now have a simple area chart that looks like the image below.
 ...
 <div className="centered-image">
<img src="https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2024/2024-02-23-recharts/area-chart.png" alt="Recharts chart" />
</div>
...
After rendering the above component, your dashboard should now have a bar chart that looks like the image below.
 ...
 <div className="centered-image">
<img src="https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2024/2024-02-23-recharts/bar-chart.png" alt="Recharts chart" />
</div>
...
After rendering the above component, the dashboard should now have a scatter chart that looks like the image below.
 ...
 <div className="centered-image">
<img src="https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2024/2024-02-23-recharts/scatter-chart.png" alt="Recharts chart" />
</div>
...
Your dashboard should now have a Pie chart that looks like the image below.
 ...
 <div className="centered-image">
<img src="https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2024/2024-02-23-recharts/pie-chart.png" alt="Recharts chart" />
</div>
...
Your dashboard should now have a Treemap that looks like the image below.
 ...
 <div className="centered-image">
<img src="https://refine.ams3.cdn.digitaloceanspaces.com/blog-yearly/2024/2024-02-23-recharts/treemap.png" alt="Recharts chart" />
</div>
