...
Below is an example taken from [here](https://github.com/acdlite/rfcs/blob/first-class-promises/text/0000-first-class-support-for-promises) showing how to fetch data with `async/await` in Server Components.
