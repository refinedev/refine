...
Are you developing a website and need a Framework? Would you be excited if we said that we can meet all your needs to for a website with a **refine** framework?
## What is Refine?
...
With **refine**'s customizable UI, you don't have to worry about your data while developing the web application you want. **refine**`s [DataProvider](https://refine.dev/docs/api-references/providers/data-provider/), you can connect to any Rest or GraphQL backend and process your data in your UI without wasting time.

Besides, it offers you more features. To browse other features, you can check out the Guides and Examples at [refine](https://refine.dev/)
## Refine Base64 Upload Example

Base64 File Upload, which we mentioned in this article, is also among the **refine** features. You can check the Base64 file upload example with **refine** below.
