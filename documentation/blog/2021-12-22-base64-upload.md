...
description: Simple base64 file upload example
slug: base64-upload
authors: melih
tags: [refine, base64, file-upload]
...
In this article, we will make and examine a simple base64 file upload example.
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="display: flex; height: 100px">
            <div style="width: 50%">
                <h6 style="margin-left: 24px">Image Preview:</h6>
                <img class="img" id="avatar" />
            </div>
            <div style="flex-grow: 1; margin-left: 30px">
                <h6>Base64 Output</h6>
                <textarea id="textArea" rows="30" cols="75"></textarea>
            </div>
        </div>
        //highlight-end
        <script src="./index.js"></script>
