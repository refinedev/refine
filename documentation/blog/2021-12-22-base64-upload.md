  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="col">
          <h6>Image Preview:</h6>
          <img class="img" id="avatar" alt="Selected image preview" />
        </div>
        <div class="col">
          <h6>Base64 Output</h6>
...
[Refer to the **Refine** Base64 Upload guide for more information. →](https://refine.dev/core/docs/guides-and-concepts/upload/base64-upload/)
