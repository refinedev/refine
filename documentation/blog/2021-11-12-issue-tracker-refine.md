        ...
        <Col xs={22}>
          <div className="container">
            <div className="imageContainer">
              <img
                src="./refine.svg"
                alt="Refine logo on authentication form"
              />
            </div>
...
Here we define our login and signup pages. We then use the Refine's [router-provider](https://refine.dev/core/docs/packages/documentation/routers/) and [useNavigation](https://refine.dev/core/docs/core/hooks/navigation/useNavigation/) hooks to switch between login and signup.
