...
[Refer to the Data Provider documentation for more information. → ](https://refine.dev/docs/data/data-provider/)
...
We also use the [`useNavigation()`](https://refine.dev/docs/api-reference/routing/hooks/useNavigation/) hook to navigate to the `show`, `edit`, and `create` pages of the `posts` resource.
