...
Ready to start building? Check out the [Refine CORE documentation](https://refine.dev/docs) for advanced topics, explore the [Refine low-code examples](https://refine.dev/examples) for real-world use cases, and join the [community](https://discord.gg/refine) to connect with other developers building with Refine.
