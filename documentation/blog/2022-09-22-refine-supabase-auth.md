...
[Refer to the Auth Provider documentation to learn more about authentication. → ](/docs/core/providers/auth-provider/index)

[Refer to the documentation to learn more routing in **refine** → ](/docs/packages/list-of-packages/index)
