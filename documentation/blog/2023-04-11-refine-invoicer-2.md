...
This is Day 2 of the [**#RefineWeek**](https://refine.dev/core/week-of-refine-strapi/) series. This five-part tutorial that aims to help developers learn the ins-and-outs of [**Refine**](https://github.com/refinedev/refine)'s powerful capabilities and get going with **Refine** within a week.
...
In this part, we will get into the details of two important providers: namely, [`dataProvider`](https://refine.dev/core/docs/data/data-provider) and [`authProvider`](https://refine.dev/core/docs/authentication/auth-provider/) that are passed to the [`<Refine />`](https://refine.dev/core/docs/api-reference/core/components/refine-config/) component. We will be building on this knowledge in the coming episodes.
