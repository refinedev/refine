...
display_title: "useOne"
sidebar_label: "useOne"
...
`useOne` is an extended version of TanStack Query's [`useQuery`](https://tanstack.com/query/v5/docs/react/reference/useQuery) that supports all of its features and adds some more.
