...
> For more information, refer to the [`useSelect` documentation](/docs/api-reference/core/hooks/useSelect/) and the [**Ant Design** `<Select/>` documentation&#8594](https://ant.design/components/select)
