...
-   `<EditButton/>` and `<ShowButton/>` are **refine** components that are used to navigate to the edit and show pages of the record, respectively.
    ...
    > For more information, refer to the [`<EditButton/>` documentation&#8594](/docs/api-reference/antd/components/buttons/edit-button/) and [`<ShowButton/>` documentation&#8594](/docs/api-reference/antd/components/buttons/show-button/)
