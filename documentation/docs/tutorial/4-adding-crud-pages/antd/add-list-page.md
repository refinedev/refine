...
First, let's create our file under the `src/pages/posts` folder. We will name it `list.tsx`. Then, we will copy the code generated by Inferencer and paste it into the file.
...
3- You can see the code generated by Inferencer. Click on the "Copy" button to copy the code.
...
Insteaf of starting from scratch, Inferencer've created the code that we can customize.
