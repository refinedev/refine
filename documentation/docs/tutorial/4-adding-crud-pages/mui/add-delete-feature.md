...
> For more information, refer to the [`<DeleteButton/>` documentation&#8594](/docs/ui-integrations/material-ui/components/buttons/delete-button)
...
import { Layout, ErrorComponent, LightTheme, RefineSnackbarProvider, useNotificationProvider } from "@refinedev/mui";
