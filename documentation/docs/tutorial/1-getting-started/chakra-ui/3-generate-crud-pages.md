...
You can learn more about [how Inferencer works](/docs/packages/list-of-packages/index) and [how to use it with Chakra UI](/docs/ui-integrations/chakra-ui/components/inferencer/index) in our documents.
