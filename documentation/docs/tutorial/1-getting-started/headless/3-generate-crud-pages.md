...
You can Learn more about [how Inferencer works](/docs/packages/list-of-packages/index) and [how to use it with Headless Mode](/docs/core/components/inferencer/index) in our documents.
