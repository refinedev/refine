...
You can Learn more about [how Inferencer works](/docs/packages/list-of-packages) and [how to use it with Material UI](/docs/ui-integrations/material-ui/components/inferencer) in our documents.
...
You will learn how to create CRUD pages manually using the code generated by Inferencer as a reference in [Unit 5](/docs/tutorial/adding-crud-pages/mui)
