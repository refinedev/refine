...
You can Learn more about [how Inferencer works](/docs/packages/list-of-packages/index) and [how to use it with Material UI](/docs/ui-integrations/material-ui/components/inferencer/index) in our documents.
