...
You can Learn more about [how Inferencer works](../../../packages/documentation/inferencer.md) and [how to use it with Material UI](../../../api-reference/mui/components/inferencer.md) in our documents.
...
You will learn how to create CRUD pages manually using the code generated by Inferencer as a reference in [Unit 5](../../4-adding-crud-pages/mui/add-list-page.md
