...
You can Learn more about [how Inferencer works](../../../packages/documentation/inferencer.md) and [how to use it with Mantine](../../../api-reference/mantine/components/inferencer.md) in our documents.
...
You will learn how to create CRUD pages manually using the code generated by Inferencer as a reference in [Unit 5](../../4-adding-crud-pages/mantine/add-list-page.md).
