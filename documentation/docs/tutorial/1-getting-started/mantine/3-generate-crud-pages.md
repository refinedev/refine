...
The `@pankod/refine-inferencer` package includes the `<MantineInferencer />` component, which can be imported from `@pankod/refine-inferencer/mantine` and used to generate CRUD pages with Ant Design components.
