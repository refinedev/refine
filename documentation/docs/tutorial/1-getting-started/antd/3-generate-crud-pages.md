...
You can Learn more about [how Inferencer works](/docs/packages/list-of-packages/index) and [how to use it with Ant Design](/docs/ui-integrations/ant-design/components/inferencer/index) in our documents.
