...
> For more information, refer to the [`<AuthPage/>` documentation &#8594](/docs/ui-integrations/mantine/components/auth-page/index)
...
For more information, refer to the [component props section of the `<AuthPage/>` documentation &#8594](/docs/ui-integrations/mantine/components/auth-page/index#props)
