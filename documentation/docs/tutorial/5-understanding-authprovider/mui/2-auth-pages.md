...
> For more information, refer to the [`<AuthPage/>` documentation &#8594](/docs/ui-integrations/material-ui/components/auth-page)
...
For more information, refer to the [component props section of the `<AuthPage/>` documentation &#8594](/docs/ui-integrations/material-ui/components/auth-page#props)
