...
> For more information, refer to the [`<AuthPage/>` documentation &#8594](/docs/api-reference/antd/components/antd-auth-page/)
...
For more information, refer to the [component props section of the `<AuthPage/>` documentation &#8594](/docs/api-reference/antd/components/auth-page.md#props)
:::
