...
```json title="/locales/en/common.json"
{
    "pages": {
        ...
        "error": {
            "infoText": "You may have forgotten to add the {{action}} component to {{resource}} resource.",
            "404text": "Sorry, the page you visited does not exist.",
            "resourceNotFound": "Are you sure you have created the {{resource}} resource.",
            "backHome": "Back Home"
        }
    },
    "buttons": {
...
```json title="/locales/tr/common.json"
{
    "pages": {
        ...
        "error": {
            "infoText": "{{action}} sayfasını {{resource}} kaynağına eklemeyi unutmuş olabilirsiniz.",
            "404text": "Üzgünüz, ziyaret ettiğiniz sayfa mevcut değil.",
            "resourceNotFound": "{{resource}} kaynağını oluşturduğunuzdan emin misiniz?",
