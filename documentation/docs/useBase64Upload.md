---
title: useBase64Upload
siderbar_label: useBase64Upload
---

The `useBase64Upload` hook allows you to easily add a base64 upload field to your form. `useBase64Upload` provides you with values to 
