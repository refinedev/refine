...
On the client-side, you can wrap your pages with [`Authenticated`](/docs/core/components/authenticated/index) component from `@refinedev/core` to protect your pages from unauthenticated access.
