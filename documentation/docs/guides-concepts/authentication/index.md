...
[To learn more about the `<Auhtenticated />` component, check out the reference page.](/docs/core/components/authenticated/index)
...
- [Headless](/docs/core/components/auth-page/index)
- [Ant Design](/docs/ui-integrations/ant-design/components/auth-page/index)
- [Material UI](/docs/ui-integrations/material-ui/components/auth-page/index)
- [Chakra UI](/docs/ui-integrations/chakra-ui/components/auth-page/index)
- [Mantine](/docs/ui-integrations/mantine/components/auth-page/index)
...
Refine provides a automatic notification system to notify users about the authentication errors. To use this feature, you need to pass [`notificationProvider`](/docs/core/providers/notification-provider/index) to the `<Refine />` component.
...
Refine provides a automatic routing system to redirect users to the desired page after the authentication process. To use this feature, you need to pass [`routerProvider`](/docs/core/providers/router-provider/index) to the `<Refine />` component.
...
[To learn more about the `authProvider` interface, check out the reference page.](/docs/core/providers/auth-provider/index)
