...
To learn more about the `routerProvider` interface, check out the [`Router Provider` section of the Core API Reference](/docs/api-reference/core/providers/router-provider).
