...
> For more information, refer to the [`<SaveButton>` documentation &#8594](/docs/ui-integrations/mantine/components/buttons/save-button/index)
...
> For more information, refer to the documentations [`<DeleteButton>` &#8594](/docs/ui-integrations/mantine/components/buttons/delete-button/index) and [`usePermission` &#8594](/docs/core/hooks/auth/use-permissions/index)
...
[save-button]: /docs/ui-integrations/mantine/components/buttons/save-button/index
