...
> For more information, refer to the [Refine Core's `useList` hook documentation &#8594](/docs/core/hooks/data/use-list/index)
...
`resource` property determines API resource endpoint to fetch records from [`dataProvider`](/docs/core/providers/data-provider/index). It returns properly configured `options` values for radio buttons.
