...
`<CloneButton>` Material UI's [`<Button>`](https://mui.com/material-ui/react-button/) component. It uses the `clone` method from [useNavigation](/docs/api-reference/core/hooks/navigation/useNavigation.md) under the hood.
