...
Clicking the button will trigger the [`useOne`](/docs/api-reference/core/hooks/data/useOne/) method and then fetch the record whose resource is "categories" and whose id is "2".
