...
If you want to invalidate the `detail` query cache when the modal is closed, you can set the `invalidateOnUnmountDetailCache` parameter to `true`. Default value is `false`.
