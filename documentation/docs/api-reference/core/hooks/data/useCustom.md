...
:::danger attention
`useCustom` should **not** be used when creating, updating or deleting a resource. To do these; [useCreate](/api-reference/core/hooks/data/useCreate.md), [useUpdate](/docs/api-reference/core/hooks/data/useUpdate/) or [useDelete](useDelete.md) hooks should be used instead.
