...
| Package                | Hooks                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| @refinedev/core        | [useTable](/docs/core/hooks/use-table/index), [useSelect](/docs/core/hooks/use-select/index)                                                                                                                                                                                                                                                                                                                                                                                     |
| @refinedev/antd        | [useTable](/docs/ui-integrations/ant-design/hooks/use-table/index), [useEditableTable](/docs/ui-integrations/ant-design/hooks/use-editable-table/index), [useSelect](/docs/ui-integrations/ant-design/hooks/use-select/index), [useSimpleList](/docs/ui-integrations/ant-design/hooks/use-simple-list/index), [useCheckboxGroup](/docs/ui-integrations/ant-design/hooks/use-checkbox-group/index), [useRadioGroup](/docs/ui-integrations/ant-design/hooks/use-radio-group/index) |
| @refinedev/react-table | [useTable](/docs/packages/list-of-packages/index)                                                                                                                                                                                                                                                                                                                                                                                                                                |
| @refinedev/mui         | [useDataGrid](/docs/ui-integrations/material-ui/hooks/use-data-grid/index), [useAutoComplete](/docs/api-reference/mui/hooks/useAutoComplete)                                                                                                                                                                                                                                                                                                                                     |
| @refinedev/mantine     | [useSelect](/docs/ui-integrations/mantine/hooks/use-select/index)                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| Package            | Hooks                                                                                                                                                                                                                                                                                                     |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| @refinedev/core    | [useShow](/docs/core/hooks/use-show/index), [useForm](/docs/api-reference/core/hooks/useForm/)                                                                                                                                                                                                            |
...
| @refinedev/mantine | [useForm](/docs/ui-integrations/mantine/hooks/use-form/index), [useDrawerForm](/docs/ui-integrations/mantine/hooks/use-drawer-form/index), [useModalForm](/docs/ui-integrations/mantine/hooks/use-modal-form/index), [useStepsForm](/docs/ui-integrations/mantine/hooks/use-steps-form/index)             |
...
| Package         | Hooks                                          |
| --------------- | ---------------------------------------------- |
| @refinedev/core | [useSelect](/docs/core/hooks/use-select/index) |
