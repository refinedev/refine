...
`useSelect` uses the `useList` hook for fetching data. [Refer to `useList` hook for details. &#8594](/api-references/hooks/data/useList.md)
...
[Refer to the `useMany` documentation for detailed usage. &#8594](/api-references/hooks/data/useMany.md)
...
If defined, it allows us to override the filters to use when fetching list of records. Thus, it . It should return [`CrudFilters`](/api-references/interfaces.md#crudfilters).
...
| filters                                           | Add filters while fetching the data                                                 | [`CrudFilters`](/api-references/interfaces.md#crudfilters)               |           |
| sort                                              | Allow us to sort the options                                                        | [`CrudSorting`](/api-references/interfaces.md#crudsorting)               |           |
