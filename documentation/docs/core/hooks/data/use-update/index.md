...
It uses the `update` method as the **mutation function** from the [`dataProvider`](/docs/core/providers/data-provider/index) which is passed to `<Refine>`.
...
| id <div className=" required">Required</div>                                                        | id for mutation function                                                                           | [`BaseKey`](/docs/core/interface-references/index#basekey)                                   |                                                              |
...
| successNotification                                                                                 | Successful Mutation notification                                                                   | [`SuccessErrorNotification`](/docs/core/interface-references/index#successerrornotification) | "Successfully updated `resource`"                            |
...
These props have default values in `RefineContext` and can also be set on [`<Refine>`](/docs/core/refine-component/index) component. `useUpdate` will use what's passed to `<Refine>` as default, but a local value will override it.
