...
It can also be set in supported [data hooks](/docs/api-references/core/hooks/data/useUpdate.md#mutation-mode) and [form hooks](/docs/api-references/core/hooks/useForm.md#properties) for fine-grained configuration.
