...
To fetch more than one record, we will use the [`useList`](/docs/core/hooks/data/use-list/index) data hook, and we will filter and fetch this data according to the search value.
