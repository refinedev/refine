...
[Check out how you can create collections with refine Appwrite guide →](/docs/packages/list-of-packages/index#create-collections)
...
export const ProductList: React.FC<IResourceComponentsProps> = () => {
  ...
  return (
    <>
      ...
      <CreateProduct modalProps={createModalProps} formProps={createFormProps} />
    </>
  );
};
```
    ...
    <Modal {...modalProps}>
      ...
      >
        ...
        <Form.Item label="Images">
          <Form.Item name="image" valuePropName="fileList" normalize={normalizeFile} noStyle>
            <Upload.Dragger
              name="file"
              listType="picture"
              multiple
