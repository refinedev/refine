...
- It uses the `updateMany` method as the **mutation function** from the [`dataProvider`](/core/docs/3.xx.xx/api-reference/core/providers/data-provider/) which is passed to `<Refine>`.
...
| ids <div className=" required">Required</div>                                                       | id for mutation function                                                                           | [`BaseKey[]`](/core/docs/3.xx.xx/api-reference/core/interfaces#basekey)                                 |                                                              |
...
| successNotification                                                                                 | Successful Mutation notification                                                                   | [`SuccessErrorNotification`](/core/docs/3.xx.xx/api-reference/core/interfaces#successerrornotification) | "Successfully updated `resource`"                            |
...
> `*`: These props have default values in `RefineContext` and can also be set on [`<Refine>`](/core/docs/3.xx.xx/api-reference/core/components/refine-config) component. `useUpdateMany` will use what is passed to `<Refine>` as default but a local value will override it.
