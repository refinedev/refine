...
For example you can [change values before sending to the API](/core/docs/3.xx.xx/api-reference/core/hooks/useForm/#how-can-i-change-the-form-data-before-submitting-it-to-the-api).
