...
- Learn about [how to use headless Inferencer](/core/docs/3.xx.xx/api-reference/core/components/inferencer/).
...
In [Unit 5](/core/docs/3.xx.xx/tutorial/adding-crud-pages/headless/index), you will learn how to create CRUD pages manually using the code generated by Inferencer as a reference.
