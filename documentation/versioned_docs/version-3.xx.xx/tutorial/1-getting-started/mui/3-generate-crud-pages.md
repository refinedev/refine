...
- Learn about [how to use Inferencer with Material UI](/core/docs/3.xx.xx/api-reference/mui/components/inferencer/).
...
In [Unit 5](/core/docs/3.xx.xx/tutorial/adding-crud-pages/mui/index), you will learn how to create CRUD pages manually using the code generated by Inferencer as a reference.
