...
- Learn about [how Inferencer works](/core/docs/3.xx.xx/packages/documentation/inferencer).
- Learn about [how to use Inferencer with Chakra UI](/core/docs/3.xx.xx/api-reference/chakra-ui/components/inferencer/).
...
In [Unit 4](/core/docs/3.xx.xx/tutorial/understanding-resources/index), the resources concept will be explained in detail. For now, you can assume that the resource is a collection of data on your API used in the app.
...
In [Unit 3](/core/docs/3.xx.xx/tutorial/understanding-dataprovider/index), it will be explained in detail how **refine** apps communicate with the API via the `dataProvider`.
...
In [Unit 5](/core/docs/3.xx.xx/tutorial/adding-crud-pages/chakra-ui/index), you will learn how to create CRUD pages manually using the code generated by Inferencer as a reference.
