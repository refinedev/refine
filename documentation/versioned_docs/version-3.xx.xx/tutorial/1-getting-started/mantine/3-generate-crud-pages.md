...
- Learn about [how to use Inferencer with Mantine](/core/docs/3.xx.xx/api-reference/mantine/components/inferencer/).
...
In [Unit 5](/core/docs/3.xx.xx/tutorial/adding-crud-pages/mantine/index), you will learn how to create CRUD pages manually using the code generated by Inferencer as a reference.
