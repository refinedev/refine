...
- Learn about [how to use Inferencer with Ant Design](/core/docs/3.xx.xx/api-reference/antd/components/inferencer/).
...
In [Unit 5](/core/docs/3.xx.xx/tutorial/adding-crud-pages/antd/index), you will learn how to create CRUD pages manually using the code generated by Inferencer as a reference.
