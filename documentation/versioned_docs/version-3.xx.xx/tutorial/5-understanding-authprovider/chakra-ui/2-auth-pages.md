...
[Refer to the `<AuthPage/>` documentation for more information &#8594](/core/docs/3.xx.xx/api-reference/chakra-ui/components/chakra-auth-page)
...
[Refer to the `<AuthPage/>` component's props to customize the auth pages &#8594](/core/docs/3.xx.xx/api-reference/chakra-ui/components/chakra-auth-page/#props)
