...
[![Open form-antd-use-steps-form example from refine](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/refinedev/refine/tree/master/examples/form-antd-use-steps-form?terminal=start&preset=node)
