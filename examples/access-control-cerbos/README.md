...
[![Open access-control-cerbos example from refine](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/refinedev/refine/tree/master/examples/access-control-cerbos?terminal=start)
