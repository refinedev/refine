...
[![Open form-core-use-form example from refine](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/refinedev/refine/tree/master/examples/form-core-use-form?terminal=start&preset=node)
