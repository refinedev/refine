...
[![Open new-routing-example example from refine](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/embed/github/refinedev/refine/tree/next/examples/new-routing-example?view=preview&theme=dark&codemirror=1)
