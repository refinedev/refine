...
[![Open upload-chakra-ui-multipart example from refine](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/refinedev/refine/tree/master/examples/upload-chakra-ui-multipart?terminal=start)
