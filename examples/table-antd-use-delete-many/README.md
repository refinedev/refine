...
[![Open table-antd-use-delete-many example from refine](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/refinedev/refine/tree/master/examples/table-antd-use-delete-many?terminal=start)
