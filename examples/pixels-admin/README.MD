...
[![Open pixels-admin example from refine](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/embed/github/refinedev/refine/tree/next/examples/pixels-admin?view=preview&theme=dark&codemirror=1)
